...
import {
    Cpu, Globe, Settings, User, Bot, Sparkles, Zap, MessageSquare, Menu, X, Fingerprint, Activity, Plus, FileText, Search, CreditCard, Home, Brain, Wallet, BarChart3, Mic, Shield
} from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-3">
                        {/* Status */}
                        <div className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-400/5 border border-emerald-400/15">
                    ...
                    >
                        <div className="px-4 pt-3 pb-4 space-y-1">
                            ...
                            <div className="pt-2 grid grid-cols-2 gap-2">
                                <div className="flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-emerald-400/5 border border-emerald-400/15">
                                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                                    <span className="text-xs text-emerald-400 font-medium">5 Agents Active</span>
                                </div>
                                <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-semibold">
                                    <Wallet className="w-4 h-4" />
                                    Connect
                                </button>
                            </div>
